...
#     project_directory = f"/{os.path.join(*dir_as_list[:index + 1])}"
    ...
    project_directory = r"C:\Users\USER\Machine Learning course\ADIP\Unet"
...
net_final = tf.keras.models.load_model('weights-improvement-87-0.58.h5',custom_objects={'binary_crossentropy_plus_dice_loss': bce_dice_loss,'iou_score': iou_score})
